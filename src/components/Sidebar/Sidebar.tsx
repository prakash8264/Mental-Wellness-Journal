  ...
  return (
    <aside className="hidden lg:flex flex-col w-72 h-[calc(100vh-2rem)] sticky top-4 my-4 ml-4 clay-card p-6 z-30">
      ...
      <div className="flex items-center justify-between pb-6 border-b-3 border-[var(--border)]">
        ...
        {streakDays > 0 && (
          <div 
            className="flex items-center gap-1 px-3 py-1 rounded-full bg-[var(--accent-mint)] text-[var(--text)] text-xs font-black border-2 border-[var(--text)] shadow-[2px_2px_0px_0px_var(--text)]"
            title={`${streakDays} Day Mindful Streak!`}
          >
